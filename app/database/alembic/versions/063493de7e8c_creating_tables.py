...
Revision ID: 063493de7e8c
Revises: 
Create Date: 2021-08-19 05:53:24.022303
...
def upgrade():
    ...
    sa.Column('shift_name', sa.String(length=120), nullable=True),
    ...
    sa.Column('construction_name', sa.String(length=150), nullable=True),
